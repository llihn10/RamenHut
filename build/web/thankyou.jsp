        ...
        <main>
            ...
            <section class="cd-position-relative cd-z-index-1 cd-padding-y-2xl">
                <div class="cd-container cd-max-width-adaptive-sm cd-text-center">
                    ...
                    <div>
                        <h1 class="cd-margin-bottom-xs">Đã đặt hàng thành công!</h1>
                        <p class="thank-you__paragraph cd-margin-bottom-xs">Cảm ơn bạn lựa chọn Ramen Hut. Ramen nóng hổi sẽ tới tay bạn trong chốc lát!</p>

                        <p><a class="cd-link" href="home">Tiếp tục order →</a></p>
                    </div>
                </div>
            </section>
        </main>
        <style>
            ...
            * {
            ...
            .cd-link {
                ...
                background-image: linear-gradient(to right, #5b3b27 50%, #5b3b27 50%);
            ...
            section.cd-position-relative {
                display: flex;
                justify-content: center;
                align-items: center;
                min-height: 100vh; /* Để căn giữa theo chiều dọc */
            }
